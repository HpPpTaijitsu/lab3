def dfs_shortest_path(graph, start, goal):
    """
    Поиск кратчайшего пути в графе с помощью DFS (полный перебор).
    """
...
if __name__ == "__main__":
    ...
    for start, goal in test_routes:
        ...
        if start == "Arad" and goal == "Bucharest":
            ...
            print(
                "  1. Arad -> Sibiu -> Rimnicu Vilcea -> Pitesti "
                "-> Bucharest"
            )
            ...
            print(
                "  3. Arad -> Timisoara -> Lugoj -> Mehadia -> "
                "Drobeta -> Craiova -> Pitesti -> Bucharest"
            )
            print(
                "     Расстояние: 118 + 111 + 70 + 75 + 120 + "
                "138 + 101 ≈ 733 км"
            )

            if distance == 418:
                print(
                    "\n   Метод поиска в глубину нашел "
                    "оптимальный путь (418 км)"
                )
                print(
                    "  Этот путь совпадает с результатом A* "
